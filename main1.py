# -*- coding: utf-8 -*-
"""
Created on Tue Dec 28 11:37:07 2021
...
def New_window():
    ...
    canvas=Canvas(window , width= _width , height=_height  )
    ...
    tk.Label(window, textvariable  =lblWord,fg="black",height=5,width=30).place(x=550,y=150)
    ...
    #canvas.create_window(window=tk.Label(window,text=("Score"+score),font=("Helvetica 10 bold"),fg ="blue").place(anchor=tk.NW))
    window.mainloop()