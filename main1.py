...
def New_window():
    ...
    tk.Button(window,text="E",font=('Helvatica 10 bold '),command=lambda: guess("I"),bg="white",fg="black",height="3",width="4").place(x=550,y=375)
    ...
    tk.Button(window, text="New\nGame", command=lambda:newGame(), font=("Helvetica 10 bold")).place(x=650,y=300)
